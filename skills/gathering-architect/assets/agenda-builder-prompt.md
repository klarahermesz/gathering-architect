...
- The session is shorter than 45 minutes. Use the opening-contract template instead.
...
> Anything specific you want the AI to consider. Example: "Use short, high-participation methods wherever you can." Example: "Build for a co-facilitator who's running it without me."
...
3. **Recommend specific facilitation methods, not generic activities.** Don't say "icebreaker": say "Three Things on a Card, 20 minutes, cards on at the door and everyone goes to find the overlap..." Use methods from `references/facilitation-methods.md`: Think, Pair, Room, Three Things on a Card, Open Space, World Café, Fishbowl, The Opening Contract, Four Showings, The Middle First, Mastermind, or others as appropriate. Match the method to the group size and vibe.
...
>
> 8. Special requests: Use short, high-participation methods where possible.
...
> | 0:20–0:45 | Three Things on a Card | Cards on at the door, then everyone finds two people whose card connects to theirs. Closes with naming who you want to talk to again. | Lowers stakes, generates buzz, surfaces real questions before content starts | Buzzy |
>
> ### HOLD (110 min)
>
...
> ### LAND (25 min)
>
> [...blocks for whole-room highlights, a Monday 9am commitment round, closing circle...]
>
> ### Trade-offs
